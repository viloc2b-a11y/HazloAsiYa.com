...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: absoluteUrl('/wic/florida/'),
    locale: 'es_US',
    title: 'WIC Florida — ingresos, cita y documentos',
    description: 'WIC en Florida: cómo pedir cita, qué llevar y qué alimentos cubre. Contenido educativo en español.',
    images: [{ url: '/images/og/default-og.jpg', width: 1200, height: 630, alt: 'WIC Florida' }],
  },
}

const faqItems = [
  {
    q: '¿Cómo pido cita para WIC en Florida?',
    a: 'Puedes llamar a tu departamento de salud del condado o buscar tu clínica WIC en myflorida.com/wic. Florida tiene clínicas WIC en todos los condados, con servicio en español en las áreas con alta población hispana.',
  },
  {
    q: '¿Cuánto tiempo tarda la primera cita WIC en Florida?',
    a: 'La primera cita suele durar 1–2 horas e incluye evaluación nutricional, medición y orientación. Lleva todos tus documentos para evitar una segunda visita.',
  },
  {
    q: '¿WIC en Florida acepta a inmigrantes sin documentos?',
    a: 'WIC no verifica el estatus migratorio. El programa es para todos los residentes de Florida que cumplan los requisitos de ingresos y necesidad nutricional, sin importar su origen.',
  },
  {
    q: '¿Qué alimentos cubre WIC en Florida?',
    a: 'WIC en Florida cubre leche, queso, huevos, cereales, jugos, frijoles, frutas y verduras, mantequilla de maní, y fórmula para bebés. Los beneficios se cargan en una tarjeta Florida WIC (eWIC).',
  },
  {
    q: '¿Puedo usar WIC en cualquier tienda en Florida?',
    a: 'Sí, en tiendas autorizadas por WIC en Florida. Puedes encontrar tiendas participantes en la app Florida WIC o preguntando en tu clínica. Incluye supermercados grandes y muchas tiendas locales.',
  },
]
...
const serviceJsonLd = {
  ...
  '@type': 'Service',
  name: 'Guía educativa WIC (Florida)',
  description: 'Información general sobre WIC en Florida. Contenido educativo.',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'WIC Florida', item: absoluteUrl('/wic/florida/') },
  ],
}

export default function WicFloridaPage() {
  return (
    <div className="min-h-screen bg-cream">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <VerifiedInfoBanner officialUrl="https://www.floridahealth.gov/programs-and-services/wic" officialLinkText="WIC Florida (DOH)" />

        <h1 className="font-serif text-3xl sm:text-4xl text-navy mt-6 mb-4">
          WIC en Florida: cómo pedir cita y qué llevar en 2026
        </h1>
        ...
        <div className="space-y-8 text-gray-700">
          ...
          <section className="rounded-xl border border-navy/10 bg-white p-5">
            <h2 className="font-serif text-xl text-navy mb-3">¿Quién puede recibir WIC en Florida?</h2>
          ...
          {/* Límites de ingresos */}
          <section className="rounded-xl border border-navy/10 bg-white p-5">
            <h2 className="font-serif text-xl text-navy mb-3">Límites de ingresos WIC Florida 2026 (orientativos)</h2>
            ...
            <p className="text-xs text-gray-400 mt-3">Fuente orientativa: USDA FNS / Florida DOH. Tu clínica verifica el monto exacto.</p>
          </section>

          {/* Documentos */}
          <section className="rounded-xl border border-navy/10 bg-white p-5">
            <h2 className="font-serif text-xl text-navy mb-3">Qué llevar a tu primera cita WIC en Florida</h2>
            <ul className="space-y-2 text-sm">
              {[
                'Identificación con foto (pasaporte, ID de Florida, matrícula consular)',
                'Comprobante de domicilio en Florida',
                'Comprobante de ingresos del mes actual',
                'Para embarazadas: confirmación del embarazo del médico',
        ...
        <p className="text-sm text-gray-500 border-t border-cream pt-6 mt-8">
          HazloAsíYa no es el DOH ni el USDA. No garantizamos aprobación de beneficios. Este contenido es educativo.
        </p>
      </article>
    </div>
  )
