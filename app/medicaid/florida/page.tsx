...
export const metadata: Metadata = {
  title: 'Cómo solicitar Medicaid en Florida en español',
  description:
    'Florida: Medicaid y CHIP en español — quién suele calificar, documentos frecuentes y cómo usar ACCESS Florida antes de aplicar.',
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <RelatedLinks
          links={RELATED_MEDICAID_FLORIDA}
          geoLinks={excludeGeoByHref(MEDICAID_STATE_GEO, '/medicaid/florida/')}
        />
